...
class GoldminePipeline(object):
    def process_item(self, item, spider):
        ...
        item_out = FinalGoldmineItem({'name': item['name'], 'address':item['address'], 'telnumber':item['telnumber'], 'email':item['email'], 'logo':item['logo'], 'website':item['website'], 'secondTelnumber': item['secondTelnumber'], 'secondWebsite': item['secondWebsite'], 'secondEmail':item['secondEmail']})
